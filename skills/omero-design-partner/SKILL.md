...
argument-hint: "[brief intent, and the path to write the sheet to]"
allowed-tools: Read, Write, Edit, Bash(cat:*), Bash(ls:*)
---
...
Intent and target path for this run: $ARGUMENTS
