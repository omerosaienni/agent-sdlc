...
## When it runs
After the judge passes an increment, before the orchestrator opens the PR. Its output (docs/) commits atomically with the increment, alongside the code. Reports are not committed; they stay local under .building/.
